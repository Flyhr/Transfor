...
- [x] **Step 1: Replace the media page skeleton**
...
- [x] **Step 2: Preserve history and queue contracts**
...
- [x] **Step 1: Add URL extraction and normalize input**
...
- [x] **Step 2: Render semantic cards**
...
- [x] **Step 3: Synchronize selection count**
...
- [x] **Step 4: Preserve queue event wiring**
...
- [x] **Step 1: Set exact Focused Flow tokens**
...
- [x] **Step 2: Set media grid breakpoints**
...
- [x] **Step 4: Render queue as horizontal task rows**
...
- [x] **Step 1: Keep the five navigation items and 176px column**

Do not add a downloads page. Store icon kind separately from label and keep `SidebarWidth = 176`.

- [x] **Step 2: Replace symbol text with a painted icon control**
...
- [x] **Step 3: Hide the version footer**
...
- [x] **Step 1: Run full offline tests**
...
- [x] **Step 3: Publish self-contained win-x64**
...
- [x] **Step 4: Inspect diff and commit locally**
